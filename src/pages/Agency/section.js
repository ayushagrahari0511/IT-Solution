              ...
              <Col lg={7} md={{ size: 7, order: 2 }} xs={{ order: 1 }}>
                <div className="title-heading mt-4 ml-lg-5">
                  <h1 className="heading mb-3">
                    ...
                    <span className="text-primary">Landrick</span> Agency
                  </h1>
                  ...
                  <div className="watch-video mt-4 pt-2">
                    ...
                    >
                      <i className="mdi mdi-play play-icon-circle text-center d-inline-block mr-2 ml-1 rounded-pill text-white position-relative play play-iconbar"></i>{" "}
                      WATCH VIDEO
                    </Link>
                    <ModalVideo
                      channel="vimeo"
