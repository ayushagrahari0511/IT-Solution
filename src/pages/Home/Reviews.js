            ...
            <Row>
              <Col lg={4} md={6} xs={12} className="mt-4 pt-2">
                <div className="clients bg-light p-4 rounded shadow">
                  ...
                  <p className="text-muted h6">
                    " The{" "}
                    <span className="text-primary">cleanest template</span> i've
                    ever used, keep it clean. "
                  </p>
              ...
              <Col lg={4} md={6} xs={12} className="mt-4 pt-2">
                <div className="clients bg-light p-4 rounded shadow">
                  <h5>Code Quality</h5>
                  <p className="text-muted h6">
                    " A really good template,{" "}
                    <span className="text-primary">highly recommended!</span> "
                  </p>
                  <Media className=" align-items-center mt-3">
                    <img src={envato} className="avatar avatar-sm" alt="" />
                    <Media body className="ml-2">
              ...
              <Col lg={4} md={6} xs={12} className="mt-4 pt-2">
                <div className="clients bg-light p-4 rounded shadow">
                  ...
                  <p className="text-muted h6">
                    " It's just <span className="text-primary">perfect!</span>{" "}
                    Thank you! "
                  </p>
                  <Media className=" align-items-center mt-3">
                    <img src={envato} className="avatar avatar-sm" alt="" />
              ...
              <Col lg={4} md={6} xs={12} className="mt-4 pt-2">
                <div className="clients bg-light p-4 rounded shadow">
                  ...
                  <p className="text-muted h6">
                    " Whery nice product. <br />{" "}
                    <span className="text-primary">Suport is very good.</span>{" "}
                    <br /> I'm lucky to work with it. <br /> Thank you so much!
                    "
                  </p>
                  <Media className=" align-items-center mt-3">
                    <img src={envato} className="avatar avatar-sm" alt="" />
            ...
            <Row className="justify-content-center">
              <Col xs={12}>
                <div className="section-title text-center">
                  <h4 className="title mb-4 text-uppercase font-weight-bold">
                    Get Started With Landrick
