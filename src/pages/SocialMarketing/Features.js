                    ...
                    <Col xs={12} className="mt-4 pt-2">
                      <Card className="explore-feature border-0 rounded text-center bg-white shadow">
                        <CardBody>
                          <div className="icon rounded-circle shadow-lg d-inline-block">
                            <i>
                              <FeatherIcon icon="aperture" className="fea" />
                            </i>
                          </div>
                    ...
                    <Col xs={12} className="mt-4 pt-2">
                      <Card className="explore-feature border-0 rounded text-center bg-white shadow">
                        <CardBody>
                          <div className="icon rounded-circle shadow-lg d-inline-block">
                            <i>
                              <FeatherIcon icon="smartphone" className="fea" />
                            </i>
                          </div>
          ...
          <Row className="align-items-center">
            ...
            >
              <div className="section-title mr-lg-4">
                <p className="text-primary h2 mb-3">
                  <i>
                    <Unicons.UilCube size="35" />
                  </i>
                </p>
                <h4 className="title mb-3">
                  We Integrated your <br /> Favorite{" "}
